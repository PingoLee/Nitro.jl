...
- **Omit the `- **Version**:` bullet** and the entry parses as `_UNSTAMPED_VERSION = v"0.1.0-"`,
  failing the stamping assertion.
...
`_parse_upgrading` warns at runtime naming the entry and which of the two happened.
