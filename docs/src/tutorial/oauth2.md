...
[Umbrella.jl](https://github.com/jiachengzhang1/Umbrella.jl) is a simple Julia authentication plugin, it supports Google and GitHub OAuth2 with more to come. Umbrella integrates with Julia web framework such as [Genie.jl](https://github.com/GenieFramework/Genie.jl), [Nitro.jl](https://github.com/PingoLee/Nitro.jl) or [Mux.jl](https://github.com/JuliaWeb/Mux.jl) effortlessly.
...
The examples will use [Nitro.jl](https://github.com/PingoLee/Nitro.jl) as the web framework, but the concept is the same for other web frameworks.
