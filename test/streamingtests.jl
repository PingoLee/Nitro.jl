...
route(["STREAM"], "/api/chunked/text", implicit_stream)
route(["STREAM"], srouter("/api/func/chunked/text"), implicit_stream)
route(["STREAM"], "/api/post/chunked/text", explicit_stream)
route(["GET"], "/api/error", implicit_stream)
