# Standard setup script for running isolated Nitro tests ou starting repl with development environment to test code
# Usage: run in repl: julia -t auto --project=test/dev_project -i test/.helpers/common_setup.jl
...
# Ensure Nitro points to the local source
