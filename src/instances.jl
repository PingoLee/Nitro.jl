...
function fullpath(path::AbstractString) :: String
    absolute_path = abspath(joinpath(@__DIR__, path))
...
"""
    instance()
Create a new self-containedinstance of the Nitro module. 
This done by creating a new unique module at runtime and loading the Nitro module into it.
This results in a unique instance of the Nitro module that can be used independently.
"""
function instance()
